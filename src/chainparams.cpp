...
{
    const char* pszTimestamp = "Captain Timo on duty";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1623916990, 100130, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfdfc82d3583ff79a6f887cddb94e7d696cfeda4c57505caaa3fe369621087c0b"));
        assert(genesis.hashMerkleRoot == uint256S("0x8a8f2ccc95813028a8de89df188e695cd44abd47861658a055e433e42445f4c6"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.timocoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.timocointools.com", true);
        // vSeeds.emplace_back("dnsseed.timocoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xfdfc82d3583ff79a6f887cddb94e7d696cfeda4c57505caaa3fe369621087c0b")},
        ...
        chainTxData = ChainTxData{
            ...
            1623916990, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1623892210, 857243, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x41e9c9d319d8a7c21df9b0ecd66998e753ce70107c601555f26e314bdfa154ce"));
        assert(genesis.hashMerkleRoot == uint256S("0x8a8f2ccc95813028a8de89df188e695cd44abd47861658a055e433e42445f4c6"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("testnet-seed.timocointools.com", true);
        // vSeeds.emplace_back("seed-b.timocoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("41e9c9d319d8a7c21df9b0ecd66998e753ce70107c601555f26e314bdfa154ce")},
            }
        };
