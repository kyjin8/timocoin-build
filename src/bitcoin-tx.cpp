...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s timocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  timocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded timocoin transaction") + "\n" +
              "  timocoin-tx [options] -create [commands]   " + _("Create hex-encoded timocoin transaction") + "\n" +
              "\n";
