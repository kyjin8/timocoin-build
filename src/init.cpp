...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/timocoin-project/timocoin>";
    const std::string URL_WEBSITE = "<https://timocoin.org>";
