...
const char * const BITCOIN_CONF_FILENAME = "timocoin.conf";
const char * const BITCOIN_PID_FILENAME = "timocoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Timocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Timocoin";
#else
    // Unix
    return pathRet / ".timocoin";
#endif
#endif
}
