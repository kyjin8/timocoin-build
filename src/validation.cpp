...
#if defined(NDEBUG)
# error "Timocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Timocoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TMC additional fees, %d delta bytes\n",
